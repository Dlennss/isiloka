...
type MinionsAdapter struct{ C *minions.Client }

func (a *MinionsAdapter) Name() string { return "minions" }
func (a *MinionsAdapter) Pay(ctx context.Context, req PayRequest) (*PayResponse, error) {
